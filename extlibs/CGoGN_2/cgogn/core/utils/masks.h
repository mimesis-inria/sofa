...
public:
	...
	inline void set_filter(const FilterFunction&& filter)
	{
//        static_assert(is_func_return_same<FilterFunction, bool>::value, "");
//        static_assert(is_func_parameter_same<FilterFunction, CellType>::value, "Badly formed FilterFunction");
		static const Orbit ORBIT = CellType::ORBIT;
