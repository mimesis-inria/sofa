...
//
//
#ifndef SOFA_COMPONENT_FORCEFIELD_CMFastTriangularBendingSprings_H
#define SOFA_COMPONENT_FORCEFIELD_CMFastTriangularBendingSprings_H
#include "config.h"
...
class CMFastTriangularBendingSprings : public core::behavior::ForceField< _DataTypes>
{
public:
    typedef _DataTypes DataTypes;
    SOFA_CLASS(SOFA_TEMPLATE(CMFastTriangularBendingSprings, DataTypes), SOFA_TEMPLATE(core::behavior::ForceField, DataTypes));
...
protected:
    ...
    sofa::component::cm_topology::EdgeData<EdgeSpring> edgeSprings;


    class TriangularBSEdgeHandler : public cm_topology::TopologyDataHandler<core::topology::MapTopology::Edge, EdgeSpring>
    {
    public:
        typedef typename CMFastTriangularBendingSprings<DataTypes>::EdgeSpring EdgeSpring;
        TriangularBSEdgeHandler(CMFastTriangularBendingSprings<DataTypes>* _ff, sofa::component::cm_topology::EdgeData<EdgeSpring>* _data)
            : sofa::component::cm_topology::TopologyDataHandler<core::topology::MapTopology::Edge, EdgeSpring>(_data)
            , ff(_ff)
        {}
        ...
        using cm_topology::TopologyDataHandler<core::topology::MapTopology::Edge, EdgeSpring>::ApplyTopologyChange;
    ...
    protected:
        CMFastTriangularBendingSprings<DataTypes>* ff;
    };
    ...
    virtual ~CMFastTriangularBendingSprings();

    sofa::component::cm_topology::EdgeData<EdgeSpring>& getEdgeInfo() {return edgeSprings;}
...
#if defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_COMPONENT_FORCEFIELD_CMFastTriangularBendingSprings_CPP)
#ifndef SOFA_FLOAT
extern template class SOFA_GENERAL_DEFORMABLE_API CMFastTriangularBendingSprings<defaulttype::Vec3dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_GENERAL_DEFORMABLE_API CMFastTriangularBendingSprings<defaulttype::Vec3fTypes>;
#endif
#endif //defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_COMPONENT_FORCEFIELD_CMFastTriangularBendingSprings_CPP)
...
#endif //SOFA_COMPONENT_FORCEFIELD_CMFastTriangularBendingSprings_H
