...
******************************************************************************/
#ifndef SOFA_COMPONENT_MAPPING_BEAMMAPPING_H
#define SOFA_COMPONENT_MAPPING_BEAMMAPPING_H
...
class BeamMapping : public core::Mapping<TIn, TOut>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE2(BeamMapping,TIn,TOut), SOFA_TEMPLATE2(core::Mapping,TIn,TOut));
    ...
    typedef defaulttype::Mat<3, 12, Real> MatElement;

protected:
    helper::vector<Coord> bary_points;
    //Coord translation;
    //Real orientation[4];
    //Mat rotation;
...
public:
    ...
    void computeMatrix(MatElement& matrixA, Real ksi, Real eta, Real zeta, Real l);
};


#if defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_COMPONENT_MAPPING_BEAMMAPPING_CPP)
#ifndef SOFA_FLOAT
extern template class SOFA_MISC_MAPPING_API BeamMapping< defaulttype::Rigid3dTypes, defaulttype::Vec3dTypes >;
extern template class SOFA_MISC_MAPPING_API BeamMapping< defaulttype::Rigid3dTypes, defaulttype::ExtVec3fTypes >;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_MISC_MAPPING_API BeamMapping< defaulttype::Rigid3fTypes, defaulttype::Vec3fTypes >;
extern template class SOFA_MISC_MAPPING_API BeamMapping< defaulttype::Rigid3fTypes, defaulttype::ExtVec3fTypes >;
#endif

#ifndef SOFA_FLOAT
#ifndef SOFA_DOUBLE
extern template class SOFA_MISC_MAPPING_API BeamMapping< defaulttype::Rigid3dTypes, defaulttype::Vec3fTypes >;
extern template class SOFA_MISC_MAPPING_API BeamMapping< defaulttype::Rigid3fTypes, defaulttype::Vec3dTypes >;
#endif
#endif
#endif
